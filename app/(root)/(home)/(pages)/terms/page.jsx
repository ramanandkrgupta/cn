    ...
    return (
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="mb-6">
          ...
          <p>
            By accessing or using <strong>Notes Mates.in</strong> (the “Website”), you agree to comply with and be bound
        ...
        <section className="mb-6">
          ...
          <p>
            ...
            on the Website. Continued use of the Website constitutes your acceptance of the updated Terms.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p>
            To use our Website, you must be at least 13 years old or the legal age of majority in your jurisdiction. By
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc pl-6">
            ...
            <li>Refrain from engaging in activities that could harm or disrupt the Website’s functionality.</li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <p>
            All content on the Website, including text, graphics, logos, and software, is the property of Notes Mates.in
            or its licensors and is protected by copyright, trademark, and other intellectual property laws. You may not
            reproduce, distribute, or create derivative works from our content without our written consent.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p>
            By submitting content to the Website (e.g., comments, reviews, or uploaded material), you grant us a
            non-exclusive, worldwide, royalty-free license to use, reproduce, modify, and distribute your content in
            connection with the operation of the Website.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p>
            Our Website may include links to third-party websites. These links are provided for your convenience, and we
            do not endorse or assume responsibility for the content or practices of these third-party websites. Use them
            at your own risk.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p>
            The Website is provided on an "as-is" and "as-available" basis. We disclaim all warranties, express or
        ...
        <section className="mb-6">
          ...
          <p>
            To the maximum extent permitted by law, Notes Mates.in shall not be liable for any indirect, incidental,
            special, consequential, or punitive damages arising out of your use or inability to use the Website, even if
        ...
        <section className="mb-6">
          ...
          <p>
            We may suspend or terminate your access to the Website at any time, without notice, for violating these Terms
        ...
        <section className="mb-6">
          ...
          <p>
            These Terms and any disputes arising from your use of the Website will be governed by and construed in
            accordance with the laws of [Your Country/State], without regard to its conflict of law principles.
          </p>
        </section>
        ...
        <p className="text-sm">
          By using Notes Mates.in, you agree to these Terms and Conditions. Thank you for being a part of our community.
        </p>
      </main>
    );
  }
