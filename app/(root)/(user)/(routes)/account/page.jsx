...
const AccountPage = () => {
  ...
  try {
    ...
    const data = {
      ...
      amount: '1',
      order_id: order_id,
      redirect_url: 'https://v1.collegenotes.tech/check-order-status',
    ...
    if (response.data.status) {
      ...
      // Ensure the payment URL is correct and not empty
      if (response.data.result.payment_url) {
      ...
      toast.error('Payment URL creation failed.');
    }
  } catch (error) {
    if (error.response) {
