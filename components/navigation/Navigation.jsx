...
import { Home, Upload, User, Brain, Search } from 'lucide-react'
    ...
    <>
      ...
      <div className="fixed bottom-20 right-4 lg:right-6 flex flex-col items-end gap-2 z-50">
        ...
        >
          ...
          />
          <span
            className={`absolute text-2xl text-white transition-transform ${
      ...
      <div className="sm:hidden fixed bottom-0 left-0 right-0 bg-base-100 shadow-lg py-3 px-6 rounded-t-xl flex justify-between items-center z-[100]">
        {Menus.map((menu, i) => {
          ...
          return (
            ...
            >
              <button
                className={`text-2xl ${
                  isActive ? 'text-primary/80' : 'text-secondary/80'
                }`}
              >
